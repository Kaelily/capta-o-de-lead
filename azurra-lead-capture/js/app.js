/**
 * AzurraERP Lead Capture & Diagnostic Engine
 */
...
class DiagnosticApp {
  ...
  initElements() {
    ...
    this.btnNavStandMode = document.getElementById('btn-nav-stand-mode');
  ...
  bindEvents() {
    ...
    if (this.btnNavStandMode) {
      this.btnNavStandMode.addEventListener('click', () => this.resetToWelcome());
    }
  ...
  calculateAndShowResult() {
    ...
    // Setup Consultation WhatsApp CTA Button for Lead
    const btnTalkConsultant = document.getElementById('btn-talk-consultant');
    if (btnTalkConsultant) {
      btnTalkConsultant.href = StorageManager.getWhatsAppLink(leadRecord);
    }
  }
